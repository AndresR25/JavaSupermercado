...
public class AgregarCliente extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        Connection conexion ;
        int codcliente=Integer.parseInt(txtID.getText());
        ...
        try{
                ...
                cstmt=conexion.prepareCall("{call Nuevo_Cliente(?,?,?,?,?) }");
                cstmt.setInt(1, codcliente);
            ...
            JOptionPane.showMessageDialog(null, "NO SE ENCUENTRA DENTRO DE LOS HORARIOS LABORALES, CONTAcTAR A SOPORTE DB"); ;
